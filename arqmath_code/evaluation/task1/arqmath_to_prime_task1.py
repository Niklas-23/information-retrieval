...
def convert_result_files_to_trec(submission_dir, qrel_result_dic, trec_dir, prim_dir):
    """
    ...
    for file in os.listdir(submission_dir):
        ...
        "Prim file"
        result_file2 = open(prim_dir + "prime_" + file, "w", newline='', encoding="utf-8")
...
def main():
    ...
    parser.add_argument('-pri', help='Directory path to save prim files')
